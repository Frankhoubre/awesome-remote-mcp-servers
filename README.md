...
- [Imaginode](https://imaginode.ai) `https://imaginode.ai/api/mcp`
  [![Imaginode MCP connector](https://glama.ai/mcp/connectors/ai.imaginode/imaginode/badges/score.svg)](https://glama.ai/mcp/connectors/ai.imaginode/imaginode)
  🔐 - Generate images and video from a prompt across 47 models, with the credit cost returned before each result.
